        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
            <div>
                ...
                <p className='text-gray-500 mb-4'>
                    Be the first to know about new products, exclusive events and offers
                </p>
                ...
                <form action="" className='flex '>
                    <input type="email" name="" id="" placeholder='enter your email' className='w-full p-3 text-sm border-t border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all' required />
            ...
            <div>
                ...
                <ul className='space-y-2 text-gray-600'>
                    ...
                    <li>
                        <Link to="#" className="hover:text-gray-500 transition-colors">Men's Buttom Wear</Link>
                    </li>
                    <li>
                        <Link to="#" className="hover:text-gray-500 transition-colors">Women's Buttom Wear</Link>
                    </li>
                </ul>
            </div>
